...
namespace Model
{
    ...
    [Table("LiquidacionFacturacion")]
    public class LiquidacionFacturacion
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int idLiquidacionesFacturacion { get; set; }
        ...
        [DisplayName("Telefono Reponsable")]
        [StringLength(100)]
        ...
        [DisplayName("Tipo Estado Nombre")]
        [StringLength(30)]
        public string tipohardwareestado { get; set; }

        [DisplayName("Tipo Descripcion Nombre")]
        [StringLength(30)]
        public string descripciontipohardwareestado { get; set; }
        ...
        [DisplayName("Se Facturo")]
        [StringLength(60)]
        public string sefacturo { get; set; }
        ...
        [DisplayName("Identificador General")]
        [StringLength(20)]
        public string IdentificadorGeneral { get; set; }


        [DisplayName("Usuario Ejecuto")]
        [StringLength(100)]
        public string UsuarioEjecuto { get; set; }

        [DisplayName("Fecha Ejecuto")]
